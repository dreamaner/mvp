package com.android.kit.view.tab.indicators;
...
public class XIndicator implements AnimatedIndicatorInterface, ValueAnimator.AnimatorUpdateListener {
    ...
    private XTabLayout dachshundTabLayout;
    ...
    public XIndicator(XTabLayout dachshundTabLayout){
