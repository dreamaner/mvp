package com.android.kit.view.tab;
...
import com.android.kit.view.tab.indicators.AnimatedIndicatorInterface;
import com.android.kit.view.tab.indicators.AnimatedIndicatorType;
import com.android.kit.view.tab.indicators.XIndicator;
import com.android.kit.view.tab.indicators.LineFadeIndicator;
import com.android.kit.view.tab.indicators.LineMoveIndicator;
import com.android.kit.view.tab.indicators.PointFadeIndicator;
import com.android.kit.view.tab.indicators.PointMoveIndicator;
...
public class XTabLayout extends TabLayout implements ViewPager.OnPageChangeListener {
    ...
    public XTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.indicatorHeight = a.getDimensionPixelSize(R.styleable.XTabLayout_ddIndicatorHeight, DimenUtils.dpToPx(DEFAULT_HEIGHT_DP));
        this.indicatorColor = a.getColor(R.styleable.XTabLayout_ddIndicatorColor, Color.WHITE);

        AnimatedIndicatorType animatedIndicatorType = AnimatedIndicatorType.values()[a.getInt(R.styleable.XTabLayout_ddAnimatedIndicator, 0)];
