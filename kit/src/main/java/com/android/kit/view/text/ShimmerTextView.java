package com.android.kit.view.text;
...
import com.android.kit.view.common.ShimmerViewBase;
import com.android.kit.view.common.ShimmerViewHelper;
...
public class ShimmerTextView extends TextView implements ShimmerViewBase {
    ...
    private ShimmerViewHelper<ShimmerTextView> shimmerViewHelper;
    ...
    public ShimmerTextView(Context context, AttributeSet attrs, int defStyle) {
        ...
        shimmerViewHelper.checkModel(this);
    }
