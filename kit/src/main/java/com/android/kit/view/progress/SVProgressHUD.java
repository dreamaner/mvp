...
public class SVProgressHUD {
    ...
    protected void initViews() {
        ...
        rootView = (ViewGroup) layoutInflater.inflate(R.layout.progress_layout_svprogresshud, null, false);
    ...
    private void setMaskType(SVProgressHUDMaskType maskType) {
        ...
        switch (mSVProgressHUDMaskType) {
            ...
            case Gradient:
                //TODO 设置半透明渐变背景
                configMaskType(R.drawable.bg_svprogress_overlay_gradient, true, false);
                break;
            case GradientCancel:
                //TODO 设置半透明渐变背景
                configMaskType(R.drawable.bg_svprogress_overlay_gradient, true, true);
                break;
            default:
                break;
        }
