...
public class SVCircleProgressBar extends View {
    ...
    public SVCircleProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        // 获取自定义属性和默认值
        roundColor = mTypedArray.getColor(R.styleable.SVCircleProgressBar_svRoundColor, Color.BLUE);
        roundProgressColor = mTypedArray.getColor(R.styleable.SVCircleProgressBar_svRoundProgressColor,
                Color.GRAY);
        roundWidth = mTypedArray.getDimension(R.styleable.SVCircleProgressBar_svRoundWidth, 5);
